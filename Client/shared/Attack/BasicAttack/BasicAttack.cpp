 ...
 * @Last modified time: 2018-02-20T22:42:01+01:00
 */
  ...
  _spriteName()
{
  ...
  _ecs.addComponent<ECS::Components::Collisionable>(_entity, ECS::Components::Collisionable(_entity, ECS::Components::Collisionable::Type::ENEMY_MISSILE));
